...
namespace CondorV.Controllers
{
    public class SitesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nom,LocalisationBarr,Type,Capacite,VillePlusProche,HauteurBarr,DistVillePlusProche,CodeRetNormal,DateMiseEnServ,LaRetenue,AgenceId")] Site site)
        {
