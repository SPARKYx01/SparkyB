...
import { Graphe3DComponent } from './graphe3-d/graphe3-d.component';
...
const routes: Routes = [
  ...
  { path: 'measure-grid/:typeGrandeurId', component: MeasureGridComponent },
{ path: 'graphe3-d',component: Graphe3DComponent},
